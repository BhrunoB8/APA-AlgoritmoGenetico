...
#------------------------------------------------------------------------------------------------------------------------------------
# def main():
#     parser = argparse.ArgumentParser(description='Rotas')
...
# start_time = tm.time()
# listaDS = [berlin52, st60, lin105]
# escolha = random.choice(listaDS)

# tamanhoPopulacao = random.randint(50, 100)
# taxaMutacao = 0.001
# tamanhoElite = random.randint(10, 30)
# geracoes = random.randint(30, 60)

# while (tamanhoElite > tamanhoPopulacao):
#     tamanhoElite = random.randint(10,30)
#     break

# print("Dataset escolhido: ", escolha , "\n")
# print("Tamanho da População: ", tamanhoPopulacao)
# print("Taxa de Mutação: ", taxaMutacao)
# print("Tamanho de Elite: ", tamanhoElite)
# print("Número de Gerações: ", geracoes)
# print("\n")
# algoritmoGeneticoPlot(escolha, tamanhoPopulacao, tamanhoElite, taxaMutacao, geracoes)

#Caso queira fazer a execução de outra maneira
# populacao = -1
# listas = [berlin52, st60, lin105]

# while populacao == -1 or not isinstance(inputPop, int):
#     try:
#         print("Selecione uma destas cidades abaixo:")
#         print("0: berlin52")
#         print("1: st60")
#         print("2: lin105")
        
        
#         inputPop = int(input('Digite qual populacao: '))
#         if inputPop >= 0 and inputPop <=2:
#             populacao = inputPop
                    
#     except ValueError:
#         print("Números apenas por favor...")


# tamanhoPopulacao = int(input('Digite o tamanho da população: '))
# tamanhoElite = int(input('Digite o tamanho do elitismo: '))
# taxaMutacao = float(input('Digite a taxa de mutação: '))
...
def main():
	...
	for n in range(args.nstart, args.nstop+1, args.nstep): #range(1, 100):
		...
		for trial in range(trials):
			...
			resultados[trial] = algoritmoGenetico(entrada)
